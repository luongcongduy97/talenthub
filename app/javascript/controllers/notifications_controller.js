...
export default class extends Controller {
  ...
  displayToast(message) {
    const toastHtml = `
      <div class="transform transition-all duration-300 ease-out translate-x-full opacity-0 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
